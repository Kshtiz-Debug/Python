...
class VoiceAssistantApp:
    def _init_(self, root):
        ...
        self.label = tk.Label(self.root, text="Ultron Voice Assistant", font=("Helvetica", 18), bg="#2C3E50",
                              fg="white")
        ...
        self.speak_button = tk.Button(self.root, text="Speak", font=("Helvetica", 14), command=self.speak_command,
                                      bg="#3498DB", fg="white", width=15)
        self.speak_button.pack(pady=10)

        self.execute_button = tk.Button(self.root, text="Execute Command", font=("Helvetica", 14),
                                        command=self.execute_from_gui, bg="#2ECC71", fg="white", width=15)
        self.execute_button.pack(pady=10)

        self.quit_button = tk.Button(self.root, text="Quit", font=("Helvetica", 14), command=self.quit, bg="#E74C3C",
                                     fg="white", width=15)
